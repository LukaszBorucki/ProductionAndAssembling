...
public class ProductionOrdersRealization {
    ...
    public ProductionOrdersRealization() {
    }

    public ProductionOrdersRealization(int id, String orderId, String saveDate, String startDateTime
